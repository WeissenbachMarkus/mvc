...
--
-- Table structure for table `modulposition`
--

DROP TABLE IF EXISTS `modulposition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modulposition` (
  ...
  PRIMARY KEY (`modul_m_name`,`masterplan_mp_id`),
  KEY `fk_modulposition_modul1_idx` (`modul_m_name`),
  KEY `fk_modulposition_masterplan1_idx` (`masterplan_mp_id`),
  CONSTRAINT `fk_modulposition_masterplan1` FOREIGN KEY (`masterplan_mp_id`) REFERENCES `masterplan` (`mp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_modulposition_modul1` FOREIGN KEY (`modul_m_name`) REFERENCES `modul` (`m_name`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modulposition`
--

LOCK TABLES `modulposition` WRITE;
/*!40000 ALTER TABLE `modulposition` DISABLE KEYS */;
/*!40000 ALTER TABLE `modulposition` ENABLE KEYS */;
UNLOCK TABLES;
